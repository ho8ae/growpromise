    ...
    >
      <SafeAreaView className="flex-1 bg-white">
          ...
          <View className="mb-6">
            ...
            <View className="mb-6">
              ...
              <Text
                ...
                style={{ color: Colors.light.text }}
              >
                쑥쑥약속(growpromise)은 다음의 목적을 위하여 개인정보를
                처리합니다:
              </Text>
              <View className="ml-4">
                <Text
            ...
            <View className="mb-6">
              ...
              <View className="ml-4">
                ...
                <Text
                  ...
                  style={{ color: Colors.light.text }}
                >
                  • 약속 및 인증 기록: 회원 탈퇴 후 1년간 보관 (서비스 분쟁
                  해결)
                </Text>
                <Text
                  className="text-sm leading-6 mb-2"
            ...
            <View className="mb-6">
              ...
              <Text
                ...
                style={{ color: Colors.light.text }}
              >
                쑥쑥약속은 원칙적으로 이용자의 개인정보를 외부에 제공하지
            ...
            <View className="mb-6">
              ...
              >
                ...
                <Text
                  ...
                  style={{ color: Colors.light.text }}
                >
                  <Text className="font-medium">처리시간:</Text> 영업일 기준 3일
                  이내
                </Text>
              </View>
            </View>
            ...
            <View className="mb-8">
              ...
              >
                ...
                최소 7일 전부터 앱 내 공지사항을 통하여 고지할 것입니다.
              </Text>
            </View>
          </View>
        </ScrollView>
        ...
        <View className="p-4 border-t border-gray-100">
          ...
          >
            <Text className="text-white text-center font-medium">확인</Text>
          </Pressable>
        </View>
      </SafeAreaView>
    </Modal>
